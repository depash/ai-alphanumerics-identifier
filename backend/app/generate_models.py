...
if __name__ == '__main__':
    ...
    num_unique_classes = len(torch.unique(all_labels))
...
# Step 4 Creating the model itself with what each layer does and how
    ...
    class alphanumericsCNN(nn.Module):
        def __init__(self, num_classes=num_unique_classes):
...
# Step 8 Saveing trained data
    ...
    torch.save(model.state_dict(), "models/alphanumerics_model.pth")

# Epoch 1/15 | Loss: 0.4231 | Acc: 87.61%
# Epoch 2/15 | Loss: 0.1852 | Acc: 93.82%
# Epoch 3/15 | Loss: 0.1599 | Acc: 94.56%
# Epoch 4/15 | Loss: 0.1455 | Acc: 94.99%
# Epoch 5/15 | Loss: 0.1354 | Acc: 95.28%
# Epoch 6/15 | Loss: 0.1271 | Acc: 95.58%
# Epoch 7/15 | Loss: 0.1224 | Acc: 95.68%
# Epoch 8/15 | Loss: 0.1171 | Acc: 95.81%
# Epoch 9/15 | Loss: 0.1137 | Acc: 95.96%
# Epoch 10/15 | Loss: 0.1099 | Acc: 96.07%
# Epoch 11/15 | Loss: 0.1069 | Acc: 96.14%
# Epoch 12/15 | Loss: 0.1046 | Acc: 96.25%
# Epoch 13/15 | Loss: 0.1014 | Acc: 96.32%
# Epoch 14/15 | Loss: 0.1000 | Acc: 96.34%
# Epoch 15/15 | Loss: 0.0970 | Acc: 96.46%
# Train Loss: 0.0970 | Train Acc: 96.46% | Val Loss: 0.1013 | Val Acc: 96.47%